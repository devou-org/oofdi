      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 items-start">
        ...
        <div className="mt-12 md:mt-0">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="/security" className="hover:underline flex items-center gap-2">
                Security
              </a>
            </li>
            <li>
              <a href="/terms" className="font-bold hover:underline flex items-center gap-2">
                Terms of Service
              </a>
            </li>
            <li>
              <a href="/help" className="font-bold hover:underline flex items-center gap-2">
                Help & Support
              </a>
            </li>
          </ul>
